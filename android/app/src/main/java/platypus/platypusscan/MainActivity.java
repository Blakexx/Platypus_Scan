...
public class MainActivity extends FlutterActivity {
    ...
    private static final String SHARE_CHANNEL = "channel:land.platypus.share/share";
    ...
    private void shareFile(String path) {
        ...
        Uri contentUri = FileProvider.getUriForFile(this, "land.platypus.share", imageFile);
